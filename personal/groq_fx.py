...
print(Groq(api_key="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").chat.completions.create(
    ...
    {json.dumps(requests.get(f"https://www.alphavantage.co/query?function=FX_DAILY&from_symbol=USD&to_symbol=JPY&interval=5min&apikey=8YUYO25GYPNE1EY8&outputsize=compact").
